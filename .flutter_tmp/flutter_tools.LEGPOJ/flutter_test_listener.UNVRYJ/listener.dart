...
import 'file:///home/mitsu/Downloads/mob/test/role_security_test.dart' as test;

const packageConfigLocation = 'file:///home/mitsu/Downloads/mob/.dart_tool/package_config.json';
...
void main() {
  ...
  StreamChannel<dynamic> testChannel = serializeSuite(() {
    catchIsolateErrors();
    goldenFileComparator = LocalFileComparator(Uri.parse('file:///home/mitsu/Downloads/mob/test/role_security_test.dart'));
